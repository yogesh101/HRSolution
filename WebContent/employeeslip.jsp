...
<%! String name,email,username,designation,exp,cno,whrs,salary,pfs,das,tas,hras,workdays,slipid,fdate,tdate,str,nets;
     int x,days;
     Float earn; %>
<%
...
try
          {
           ...
           String str="Select name,email,designation,cno,WHRS,SALARY,PFS,DAS,TAS,HRAS,NETS,fdate,tdate,slipid from empslip where ecode=?";
...
<div align="center"><input type="button" onclick="window.print()" value="Print"></input></div>
  ...
  <div id="footer">
    <p class="center">Copyright &copy; 2010, CMC LTD, All Rights Reserved</p>
