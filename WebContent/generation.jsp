...
<div class="shell">
  <div class="border">
    ...
    <div id="main">
        ...
        <div class="highlight">    
          <h3>CMC LTD PAY SLIP GENERATION</h3>
        ...
        try
          {
           ...
           String str="Select fname,lname,email,uname,designation,exp,contactno from employee where ecode=?";
...
<form id="generation" name="generation" method="post" action="paydb.jsp?id=<%=id%>">
  <table width="962" border="0">
    <tr>
      ...
      <td width="303"><div align="center"><strong>CMC LTD. </strong></div></td>
    </tr>
    <tr>
